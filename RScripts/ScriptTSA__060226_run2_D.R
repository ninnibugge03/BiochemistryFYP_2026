...
library(readxl)
TSA_raw <- read_excel("C:/Users/ninni/Desktop/TSA Results/8BiochemFYP_060226_run2_D.xlsx", 
                      sheet = "Sheet2", skip = 1)

png("TSA_figure9.png", width=2400, height=1050, res=450)
...
legend("topleft",
       legend = c(expression(paste("Baseline (dH"[2]*"O)")),
                  ...
                  expression(paste("DAUDA (18.41"*mu*"M)"))),
...
arrows(70,5100, Mean_Tm_DAUDA+0.4, 5350, # x,y end and x,y start coordinates
       length = 0.025,
       angle = 30,
       code = 1,
       col = "mediumvioletred")

text(68.5, 5100, # numerical vector( x,y) for text placement
...
arrows(70,2900, Mean_Tm_EtOH+0.4, 3250,
       length = 0.025,
       angle = 30,
       code = 1,
       col = "dodgerblue2")
...
arrows(70,3600, Mean_Tm_ctrl+0.4, 3250,
       length = 0.025,
       angle = 30,
       code = 1,
       col = "black")
