...
png("TSA_figure10.2.png", width=2400, height=1050, res=450)
...
TSA_mine <- TSA_mine[TSA_mine$A6 != "UNK-21", ]
...
arrows(70,4800, Mean_Tm_EPA+0.4, 5325, # x,y end and x,y start coordinates
       length = 0.025,
       angle = 30,
       code = 1,
       col = "magenta")
...
arrows(70,4100, Mean_Tm_EtOH+0.4, 4400,
       length = 0.025,
       angle = 30,
       code = 1,
       col = "dodgerblue")
...
arrows(70,3400, Mean_Tm_ctrl-0.2, 4300,
       length = 0.025,
       angle = 30,
       code = 1,
       col = "black")
