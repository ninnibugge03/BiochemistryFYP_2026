...
library(readxl)
TSA_raw <- read_excel("C:/Users/ninni/Desktop/TSA Results/4BiochemFYP_020226_run2.xlsx", 
                      sheet = "Sheet2", skip = 1)

png("TSA_figure5.1.png", width=2400, height=1050, res=450)
...
legend("topright",
       legend = c(expression(paste("Baseline (dH"[2]*"O)")),
                  ...
                  expression(paste("EPA (39.67"*mu*"M)"))),
